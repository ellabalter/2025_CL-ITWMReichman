...
void Awake()
{
    ...
    lightsource_red1.intensity      = 0.5f;
    lightsource_yellow1.intensity   = 0.4f;
    lightsource_green1.intensity    = 0.3f;
    ...
    if(traffic_light_type_single == false)
    {
        ...
        lightsource_red2.intensity      = 0.5f;
        lightsource_yellow2.intensity   = 0.4f;
        lightsource_green2.intensity    = 0.3f;
    }
